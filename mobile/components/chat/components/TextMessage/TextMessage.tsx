import { LinkPreview, PreviewData, REGEX_LINK, } from '@flyerhq/react-native-link-preview'
...
export const TextMessage = ({
  ...
  const { descriptionText, headerText, titleText, text, textContainer, createdAt } =
    styles({
      message,
      theme,
      user,
  ...
  REGEX_LINK.test(message.text.toLowerCase()) ? (
    ...
    <View style={textContainer}>
      ...
      <Text style={createdAt}>
        {dayjs(message.createdAt).format('h:m a')}
      </Text>
    </View>
  )
}
